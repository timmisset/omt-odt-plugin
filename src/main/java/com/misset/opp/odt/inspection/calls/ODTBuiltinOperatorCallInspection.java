...
public class ODTBuiltinOperatorCallInspection extends LocalInspectionTool {
    @Override
    public @Nullable
    @Nls String getStaticDescription() {
        return "Inspect calls made from the ODT language to ODT BuiltIn Operators";
    }
        ...
        return new ModelAwarePsiElementVisitor() {
            ...
            public void visitElement(@NotNull PsiElement element) {
                if (element instanceof ODTCall) {
                    ...
                    if (callable instanceof BuiltInOperator) {
