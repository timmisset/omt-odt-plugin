...
public class TTLVerbImpl extends ASTWrapperPsiElement implements TTLVerb {

  public TTLVerbImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public TTLPredicate getPredicate() {
    return findChildByClass(TTLPredicate.class);
  }
