...
public class TTLPredicateObjectListImpl extends ASTWrapperPsiElement implements TTLPredicateObjectList {

  public TTLPredicateObjectListImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<TTLPredicateObject> getPredicateObjectList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, TTLPredicateObject.class);
  }
