...
class ODTDefineStatementAbstractTest extends ODTTestCase {
    ...
    void testReturnTypeReturnsUriType() {
        ...
        ReadAction.run(() -> {
            ...
            Assertions.assertEquals(OntologyModel.getInstance(getProject()).toIndividuals("http://ontology#ClassA"), resolve);
        });
    }
}
